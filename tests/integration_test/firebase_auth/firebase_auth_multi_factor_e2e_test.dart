...
void main() {
  ...
  group('$MultiFactor', () {
    ...
    group('enrollFactor', () {
      ...
      test(
        ...
        () async {
          ...
          await expectLater(
            user.multiFactor.unenroll(factorUid: 'unknown'),
      ...
      test('should not enroll factor if email not verifed', () async {
    ...
    group('signIn', () {
      test('should sign in with 2 factors', () async {
        ...
        try {
          userCredential = await FirebaseAuth.instance
              .signInWithEmailAndPassword(email: email, password: testPassword);
        } catch (e) {
        ...
        Future<String> getCredentialSignIn() async {
          ...
          unawaited(
            FirebaseAuth.instance.verifyPhoneNumber(
              multiFactorInfo:
                  multiFactorException.resolver.hints.first
        ...
        await exception.resolver.resolveSignIn(
          PhoneMultiFactorGenerator.getAssertion(credentialSignIn),
        );
