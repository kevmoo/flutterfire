...
void main() {
  ...
  group('firebase_remote_config', () {
    ...
    // EventChannel here.
    test('onConfigUpdated can run without issue', () async {
      final configSubscription = FirebaseRemoteConfig.instance.onConfigUpdated
          .listen((event) {});
    ...
    test('getAll() returns without throwing', () async {
      try {
        await FirebaseRemoteConfig.instance.fetchAndActivate();
        FirebaseRemoteConfig.instance.getAll();
    ...
    group('setCustomSignals()', () {
      ...
      test('invalid signal values throws assertion', () async {
        const signals = <String, Object?>{'signal1': true};
        ...
        const signals4 = <String, Object?>{'signal1': false};
