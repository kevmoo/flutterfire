  ...
  group('$Reference', () {
    ...
    group('putData', () {
      ...
      test(
        ...
        () async {
          final Uint8List jsonData = utf8.encode(jsonEncode({'key': 'value'}));
          final Reference ref = storage
              .ref('flutter-tests')
              .child('flt-infer.json');
    ...
    group(
      ...
      () {
        test(
          ...
          () async {
            ...
            final Reference ref2 = storage
                .ref('flutter-tests')
                .child('flt-ok-2.txt');
            final TaskSnapshot complete2 = await ref2.putFile(file);
        ...
        test(
          'Upload and download text file and ensure content is the same',
          () async {
            const text =
            ...
            final Reference ref = storage
                .ref('flutter-tests')
                .child('read-and-write.txt');

            final TaskSnapshot complete = await ref.putFile(file);
