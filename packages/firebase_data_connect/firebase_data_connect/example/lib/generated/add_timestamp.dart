...
class AddTimestampTimestampHolderInsert {
  ...
  const AddTimestampTimestampHolderInsert({required this.id});
}
...
class AddTimestampData {
  ...
  const AddTimestampData({required this.timestampHolder_insert});
}
...
class AddTimestampVariables {
  ...
  const AddTimestampVariables({required this.timestamp});
}
