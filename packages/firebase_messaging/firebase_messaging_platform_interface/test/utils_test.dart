...
void main() {
  group('Utilities', () {
    group('convertToAndroidNotificationPriority', () {
      test(
        'returns correct AndroidNotificationPriority for priority value',
        () {
          expect(
            convertToAndroidNotificationPriority(-2),
            AndroidNotificationPriority.minimumPriority,
          );
          expect(
            convertToAndroidNotificationPriority(-1),
            AndroidNotificationPriority.lowPriority,
          );
          expect(
            convertToAndroidNotificationPriority(0),
      ...
      test('returns AndroidNotificationPriority.defaultPriority '
          'if priority is not a possible value', () {
        expect(
          convertToAndroidNotificationPriority(-3),
          AndroidNotificationPriority.defaultPriority,
        );
        expect(
          convertToAndroidNotificationPriority(3),
      ...
      test('returns AndroidNotificationPriority.defaultPriority '
          'if priority is null', () {
        expect(
          convertToAndroidNotificationPriority(null),
          AndroidNotificationPriority.defaultPriority,
        );
      });
    });
    ...
    group('convertAndroidNotificationPriorityToInt', () {
      test(
        'returns correct priority value for AndroidNotificationPriority',
        () {
          expect(
      ...
      test('returns the priority value that represents '
          'AndroidNotificationPriority.defaultPriority '
    ...
    group('convertToAndroidNotificationVisibility', () {
      test(
        'returns correct AndroidNotificationVisibility for visibility value',
        () {
          expect(
            convertToAndroidNotificationVisibility(-1),
            AndroidNotificationVisibility.secret,
          );
          expect(
            convertToAndroidNotificationVisibility(0),
      ...
      test('returns AndroidNotificationVisibility.private '
          'if visibility is no a possible value', () {
        expect(
          convertToAndroidNotificationVisibility(-2),
          AndroidNotificationVisibility.private,
        );
        expect(
          convertToAndroidNotificationVisibility(2),
      ...
      test('returns AndroidNotificationVisibility.private '
        ...
        expect(
          convertToAndroidNotificationVisibility(null),
          AndroidNotificationVisibility.private,
        );
      });
    });
    ...
    group('convertAndroidNotificationVisibilityToInt', () {
      test(
        'returns correct visibility value for AndroidNotificationVisibility',
        () {
          expect(
      ...
      test('returns the visibility value that represents '
          'AndroidNotificationVisibility.private '
    ...
    group('convertToAuthorizationStatus()', () {
      test('returns correct AuthorizationStatus for status value', () {
        expect(
          convertToAuthorizationStatus(-1),
        ...
        expect(
          convertToAuthorizationStatus(2),
          AuthorizationStatus.provisional,
        );
      });

      test('returns AuthorizationStatus.notDetermined '
        ...
        expect(
          convertToAuthorizationStatus(3),
          AuthorizationStatus.notDetermined,
        );
      });
      ...
      test('returns AuthorizationStatus.notDetermined '
          'if status is null', () {
        expect(
          convertToAuthorizationStatus(null),
          AuthorizationStatus.notDetermined,
        );
      });
    });
    ...
    group('convertToAppleNotificationSetting', () {
      test('returns correct AppleNotificationSetting for status value', () {
        expect(
          convertToAppleNotificationSetting(-1),
          AppleNotificationSetting.notSupported,
        );
        expect(
          convertToAppleNotificationSetting(0),
      ...
      test('returns AppleNotificationSetting.notSupported '
          'if status is no a possible value', () {
        expect(
          convertToAppleNotificationSetting(-2),
          AppleNotificationSetting.notSupported,
        );
        expect(
          convertToAppleNotificationSetting(2),
      ...
      test('returns AppleNotificationSetting.notSupported '
          'if status is null', () {
        expect(
          convertToAppleNotificationSetting(null),
          AppleNotificationSetting.notSupported,
        );
      });
    });
    ...
    group('convertToAppleShowPreviewSetting', () {
      test('returns correct AppleShowPreviewSetting for status value', () {
        expect(
          convertToAppleShowPreviewSetting(-1),
          AppleShowPreviewSetting.notSupported,
        );
        expect(
          convertToAppleShowPreviewSetting(0),
        ...
        expect(
          convertToAppleShowPreviewSetting(2),
          AppleShowPreviewSetting.whenAuthenticated,
        );
      });

      test('returns AppleShowPreviewSetting.notSupported '
          'if status is no a possible value', () {
        expect(
          convertToAppleShowPreviewSetting(-2),
          AppleShowPreviewSetting.notSupported,
        ...
        expect(
          convertToAppleShowPreviewSetting(3),
          AppleShowPreviewSetting.notSupported,
        );
      });
      ...
      test('returns AppleShowPreviewSetting.notSupported '
          'if status is null', () {
        expect(
          convertToAppleShowPreviewSetting(null),
          AppleShowPreviewSetting.notSupported,
        );
      });
    });
