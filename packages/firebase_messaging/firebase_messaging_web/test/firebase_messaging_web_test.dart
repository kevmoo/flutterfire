...
void main() {
  group('firebase_messaging_web utils', () {
    test('convertToAuthorizationStatus()', () {
      AuthorizationStatus grantedStatus = convertToAuthorizationStatus(
        'granted',
      );
      AuthorizationStatus deniedStatus = convertToAuthorizationStatus('denied');
      AuthorizationStatus defaultStatus = convertToAuthorizationStatus(
        'default',
      );
      AuthorizationStatus anyOtherStatus = convertToAuthorizationStatus(
        'random string',
      );
    ...
    test('getNotificationSettings()', () {
      ...
      NotificationSettings deniedNotification = getNotificationSettings(
        'denied',
      );
      NotificationSettings defaultNotification = getNotificationSettings(
        'default',
      );
      NotificationSettings randomNotification = getNotificationSettings(
        'random string',
      );
