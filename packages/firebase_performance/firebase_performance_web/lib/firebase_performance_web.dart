import 'package:meta/meta.dart';// Copyright 2022, the Chromium project authors.  Please see the AUTHORS file
...
class FirebasePerformanceWeb extends FirebasePerformancePlatform {
  ...
  Future<bool> isPerformanceCollectionEnabled() async {
    ...
    return Future.value(
      _interopSettings == null ? true : _interopSettings!.dataCollectionEnabled,
    );
  }
  ...
  Future<void> setPerformanceCollectionEnabled(bool enabled) async {
    ...
    _interopSettings = performance_interop.PerformanceSettings.getInstance(enabled);
  }
